        ...
        <?php foreach($viewData['products'] as $product) : ?>
          ...
          <div class="product col-xl-3 col-lg-4 col-sm-6">
            ...
            <div class="product-action-buttons">
              <a href="<?= $router->generate('catalog-product', ['id' => $product->getId()]) ?>" class="btn btn-outline-dark btn-product-left"><i class="fa fa-shopping-cart"></i></a>
            ...
            <div class="py-2">
              <p class="text-muted text-sm mb-1">nom catégorie</p>
